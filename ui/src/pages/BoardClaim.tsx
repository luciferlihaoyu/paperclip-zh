...
export function BoardClaimPage() {
      ...
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            {statusQuery.error instanceof Error ? statusQuery.error.message : t("boardClaim.unavailableDesc")}
          </p>
        </div>
      </div>
    );
  ...
  if (!status) {
    return <div className="mx-auto max-w-xl py-10 text-sm text-destructive">{t("boardClaim.unavailableShort")}</div>;
  }
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        >
          {claimMutation.isPending ? t("boardClaim.claiming") : t("boardClaim.claimOwnershipBtn")}
        </Button>
      </div>
    </div>
  );
