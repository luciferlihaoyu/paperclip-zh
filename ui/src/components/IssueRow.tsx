...
export function IssueRow({
  ...
  const productivityReviewIndicator = productivityReview ? (
    <span
      ...
      title={`${t("components.issueRow.productivityReview")}: ${productivityReviewTriggerLabel(productivityReview.trigger)}`}
      aria-label={t("components.issueRow.productivityReview")}
    >
  ...
  const parkedBlockerIndicator = hasAssignedBacklogBlocker(issue.blockedBy) ? (
    <span
      ...
      title=t("components.issueRow.blockedByParked")
    >
        ...
        <span className="inline-flex h-4 w-4 shrink-0 items-center justify-center self-center">
          {showUnreadDot ? (
            <button
              ...
              aria-label={t("components.issueRow.markAsRead")}
            >
              <span
                className={cn(
            ...
            <button
              ...
              aria-label={t("components.issueRow.dismissFromInbox")}
            >
